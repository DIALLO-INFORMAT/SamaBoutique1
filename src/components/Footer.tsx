      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm">
              Votre partenaire de confiance pour des produits et services de qualité. Nous nous engageons à offrir le meilleur à nos clients.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/suivi" className="hover:text-primary transition-colors">Suivi de Commande</Link></li>
