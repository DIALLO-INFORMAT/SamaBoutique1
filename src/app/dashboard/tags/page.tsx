                ...
                <CardContent className="p-0">
                    {tags.length === 0 ? (
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    <TableHead className="px-6 text-base">{t('manager_tags_table_name')}</TableHead>
                                    <TableHead className="text-right px-6 w-[100px] text-base">{t('manager_tags_table_actions')}</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {tags.map((tag) => (
                                            ...
                                            <AlertDialog>
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownMenuContent align="end">
                                                        ...
                                                        <DropdownMenuItem onClick={() => openEditDialog(tag)} className="cursor-pointer text-base">
                ...
                <DialogContent className="sm:max-w-[425px]">
                    ...
                    <div className="grid gap-4 py-4">
                        <div className="space-y-2">
                            <Label htmlFor="tag-name" className="text-base">{t('manager_tags_table_name')}</Label>
                            <Input
                                id="tag-name"
                                value={tagName}
